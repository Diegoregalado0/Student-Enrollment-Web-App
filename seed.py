...
with app.app_context():
    ...
    enrollments = [
        ...
        Enrollment(student_id=s3.id, course_id=physics.id, grade=85),
        Enrollment(student_id=s4.id, course_id=physics.id, grade=88),
        Enrollment(student_id=s5.id, course_id=physics.id, grade=94),
        Enrollment(student_id=chuck.id, course_id=cs106.id, grade=95),
        Enrollment(student_id=s3.id, course_id=cs106.id, grade=76),
        Enrollment(student_id=s6.id, course_id=cs106.id, grade=89),
        Enrollment(student_id=s7.id, course_id=cs106.id, grade=82),
        Enrollment(student_id=mindy.id, course_id=math.id, grade=91),
        Enrollment(student_id=s4.id, course_id=math.id, grade=84),
        Enrollment(student_id=s5.id, course_id=math.id, grade=79),
        Enrollment(student_id=s6.id, course_id=math.id, grade=87),
        Enrollment(student_id=s4.id, course_id=cs162.id, grade=90),
        Enrollment(student_id=s5.id, course_id=cs162.id, grade=86),
        Enrollment(student_id=s7.id, course_id=cs162.id, grade=93),
        Enrollment(student_id=s8.id, course_id=cs162.id, grade=81),
    ]
